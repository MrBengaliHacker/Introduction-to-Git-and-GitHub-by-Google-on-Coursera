...
When writing a `.gitignore` file, there are some specific formats which help tell Git how to read the text in the file.  
For example, a line starting with `#` is a comment; a slash `/` is a directory separator.  Visit   
https://git-scm.com/docs/gitignore to see more examples.

[This GitHub repository](https://github.com/github/gitignore) offers some examples of configurations which are often included in a `.gitignore` file.  
These examples include: compiled sources, packages, logs, databases, and OS generated files.